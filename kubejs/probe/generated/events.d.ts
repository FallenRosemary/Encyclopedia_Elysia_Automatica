...
declare function onForgeEvent(name: "com.paleimitations.schoolsofmagic.common.spells.events.SpellEvent$UsesPerCharge", handler: (event: Internal.SpellEvent$UsesPerCharge) => void);
